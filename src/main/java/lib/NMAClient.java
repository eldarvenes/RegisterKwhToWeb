...
public class NMAClient {
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 4) {
            ...
            System.out.println("java -jar NMAClient.jar <apikey> <application_name> <event> <description> [priority] [devkey]");
            return;
        }
        // Load parameters
        ...
        if (NMAClient.notify(lAppName, lEvent, lDesc, lPriority, lApiKey, devKey) == 1) {
